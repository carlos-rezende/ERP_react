// Caminho da página: radioprotecao/home/folha de doses
...
// Componente funcional FolhaDeDosesPage
const FolhaDeDosesPage = () => {
  ...
  return (
    <div className="container mx-auto py-3">
      <h1 className="text-2xl font-bold mb-4 mt-10">Folha de Doses</h1>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex mt-16 mb-5">
          <a href="/radioprotecao/folha de doses/admitidos" className="bg-gray-800 hover:bg-black rounded-lg text-white font-mono border border-gray-700 transition shadow-lg hover:shadow-xl active:shadow-2xl hover:text-orange-500 duration-300 p-2 mr-5">
            Admitidos
          </a>
          {/* Página de Demitidos. */}
          <a href="/radioprotecao/folha de doses/demitidos" className="bg-gray-800 hover:bg-black rounded-lg text-white font-mono border border-gray-700 transition shadow-lg hover:shadow-xl active:shadow-2xl hover:text-orange-500 duration-300 p-2">
            Demitidos
          </a>
        </div>
      </div>
            ...
            {Array.isArray(displayedUsers) && displayedUsers.length > 0 ? (
              displayedUsers.map((user) => (
                <tr key={user.id}>
                  ...
                  {/* Botão de visualizar com ícone da React-Icon. */}
...
export default FolhaDeDosesPage;

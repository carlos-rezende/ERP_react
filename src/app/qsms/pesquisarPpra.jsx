...
// Caminho da página: qsms/pesquisas/pesquisarppra

export default function PesquisarPpra() {

    return (
      <main className="grid min-h-full px-6 py-24 bg-gray-300 place-items-center sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-indigo-600">QSMS - Pesquisar PPRA</p>
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">PÁGINA PPRA</h1>

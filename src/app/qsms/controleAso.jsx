// Caminho da página: qsms/controle de ASO's

// Importação da biblioteca React e do Hook useState.
import React, { useState } from 'react';

// Componente funcional ControleAsos.
const ControleAsos = () => {
  ...
  return (
    <div className="container py-3 w-full md:w-auto">
      <h1 className="text-2xl font-bold mb-4 mt-10">Controle de Aso's</h1>
      <p className="font-mono bg-gray-300 text-center mt-10">Funcionários</p>
